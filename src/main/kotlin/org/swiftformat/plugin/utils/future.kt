...
/**
 * Run [fn] on a pooled background thread and show IntelliJ's indeterminate progress bar while it's
 * running.
 *
  ...
  ProgressManager.getInstance()
      .run(
          object : Task.Backgroundable(project, progressTitle) {
            ...
            // NOTE: At first I thought that you should override [onThrowable] to make the future
            // complete
            // exceptionally, but when I did that, the exceptions were still escaping to the
            // top-level.
